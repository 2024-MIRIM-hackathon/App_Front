...
const book: React.FC<SvgProps> = (props) => (
  <Svg width="59" height="46" viewBox="0 0 59 46" fill="none" {...props}>
    <Path d="M1 1.8302L3.09559 1.8302L29.5 11.5646L55.9044 1.8302L58 1.8302V38.2282C52.9706 37.805 39.9779 38.6514 29.5 44.9999C18.7706 38.5668 5.75 37.805 1 38.2282L1 1.8302Z" fill="white" stroke="#424242" stroke-width="0.811555" stroke-linejoin="round" />
