...
const wordData = [
    ...
    { word: "문화", meaning: "한 사회나 민족이 공유하는 생활 방식.", example: "문화는 국가의 정체성을 형성한다.", bookmarked: false, showMore: false },
    { word: "보편", meaning: "모든 것에 두루 미치거나 통함.", example: "사람들은 보편적으로 사랑하는 사람을 행복하게 하고 싶어 해.", bookmarked: true, showMore: false },
    { word: "사랑", meaning: "누군가나 무언가에 대해 강한 애정을 느끼는 감정.", example: "그는 사랑하는 사람에게 편지를 썼다.", bookmarked: false, showMore: false },
    { word: "소통", meaning: "의사소통을 통해 이해하는 과정.", example: "효과적인 소통이 필요하다.", bookmarked: false, showMore: false },
    { word: "행복", meaning: "기쁘고 만족스러운 상태.", example: "그는 항상 행복하게 살고 싶어 한다.", bookmarked: false, showMore: false },
    { word: "철학", meaning: "인생, 우주, 인간 존재의 근본 원리를 탐구하는 학문.", example: "그는 어릴 때부터 철학에 관심이 많았다.", bookmarked: false, showMore: false },
    { word: "평화", meaning: "전쟁이나 분쟁이 없는 상태.", example: "모든 사람은 평화를 원한다.", bookmarked: true, showMore: false },
    { word: "지혜", meaning: "사리분별이 뛰어나고 올바르게 판단하는 능력.", example: "그는 지혜로운 결정을 내렸다.", bookmarked: false, showMore: false },
    { word: "혁신", meaning: "낡은 것을 바꾸어 새롭게 함.", example: "기업들은 지속적인 혁신을 통해 경쟁력을 유지한다.", bookmarked: true, showMore: false },
];
...
function Dictionary() {
    ...
    const toggleShowMore = (index: number) => {
        ...
        updatedWords[index].showMore = !updatedWords[index].showMore;
